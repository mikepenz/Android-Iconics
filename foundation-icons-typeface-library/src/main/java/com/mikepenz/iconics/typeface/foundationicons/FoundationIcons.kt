 ...
 */
package com.mikepenz.iconics.typeface.foundationicons
...
class FoundationIcons : ITypeface {
    ...
    enum class Icon constructor(character: Char) : IIcon {
        ...
        companion object {
            ...
            private val savedTypeface: ITypeface by lazy { FoundationIcons() }
        }
    }

    companion object {
        private const val TTF_FILE = "foundation-icons-font-v3.0.0.1.ttf"
