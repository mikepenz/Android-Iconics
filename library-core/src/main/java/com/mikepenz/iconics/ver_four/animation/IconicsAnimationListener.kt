...
interface IconicsAnimationListener {
     ...
     */
    fun onAnimationStart(processor: com.mikepenz.iconics.ver_four.animation.IconicsAnimationProcessor, isReverse: Boolean) {
     ...
     * @param isReverse Whether the processor is playing in reverse.
     */
    fun onAnimationEnd(processor: com.mikepenz.iconics.ver_four.animation.IconicsAnimationProcessor, isReverse: Boolean) {
     ...
     * @param processor The started processor.
     */
    fun onAnimationStart(processor: com.mikepenz.iconics.ver_four.animation.IconicsAnimationProcessor) {}
     ...
     * @param processor The processor which reached its end.
     */
    fun onAnimationEnd(processor: com.mikepenz.iconics.ver_four.animation.IconicsAnimationProcessor) {}
     ...
     */
    fun onAnimationCancel(processor: com.mikepenz.iconics.ver_four.animation.IconicsAnimationProcessor) {}
     ...
     */
    fun onAnimationRepeat(processor: com.mikepenz.iconics.ver_four.animation.IconicsAnimationProcessor) {}
}