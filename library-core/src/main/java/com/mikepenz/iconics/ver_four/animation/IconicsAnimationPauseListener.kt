...
interface IconicsAnimationPauseListener {
     ...
     */
    @RequiresApi(Build.VERSION_CODES.KITKAT)
    fun onAnimationPause(processor: com.mikepenz.iconics.ver_four.animation.IconicsAnimationProcessor) {
    }
     ...
     */
    @RequiresApi(Build.VERSION_CODES.KITKAT)
    fun onAnimationResume(processor: com.mikepenz.iconics.ver_four.animation.IconicsAnimationProcessor) {
    }
}