...
open class BlinkAlphaProcessor(
    ...
    override var duration: Long = com.mikepenz.iconics.ver_four.animation.BlinkAlphaProcessor.Companion.DEFAULT_DURATION,
    ...
    override fun animationTag(): String = "blink_alpha"
