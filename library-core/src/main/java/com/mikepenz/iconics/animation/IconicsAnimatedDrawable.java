...
public class IconicsAnimatedDrawable extends IconicsDrawable {
    private @NonNull List<IconicsAnimationProcessor> mProcessors = new ArrayList<>();
    ...
    @Override public int getCompatAlpha() {
        return mIconBrush.getAlpha();
    }
     ...
     * */
    public @NonNull IconicsAnimatedDrawable processors(@NonNull IconicsAnimationProcessor... processors) {
     ...
     * {@link Runner#unset()}
     * */
    public @NonNull Runner animateIn(@Nullable View view) {
