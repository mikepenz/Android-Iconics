...
public class IconicsLayoutInflater extends LayoutInflater {
    ...
    protected IconicsLayoutInflater(Context context) {
        super(context);
        mIconicsFactory = new IconicsFactory();
        setUpLayoutFactories(false);
    }

    protected IconicsLayoutInflater(LayoutInflater original, Context newContext, boolean cloned) {
    ...
    public LayoutInflater cloneInContext(Context newContext) {
        return new IconicsLayoutInflater(this, newContext, true);
    }
...
//            LayoutInflaterCompat.setFactory(this, new WrapperFactory2(factory2, mCalligraphyFactory));
    ...
    private static class WrapperFactory implements Factory {
        ...
        private final IconicsLayoutInflater mInflater;
        private final IconicsFactory mIconicsFactory;

        public WrapperFactory(Factory factory, IconicsLayoutInflater inflater, IconicsFactory iconicsFactory) {
            mFactory = factory;
            mInflater = inflater;
    ...
    private static class PrivateWrapperFactory2 extends WrapperFactory2 {
        ...
        public PrivateWrapperFactory2(Factory2 factory2, IconicsLayoutInflater inflater, IconicsFactory iconicsFactory) {
